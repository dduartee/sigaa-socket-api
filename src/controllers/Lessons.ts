...
export class Lessons {
    ...
    async list(query: {
        ...
        try {
            ...
            const { JSESSIONID, jsonCache, sigaaURL } = cacheService.get<CacheType>(uniqueID);
            ...
            const { account, httpSession } = await AuthenticationService.loginWithJSESSIONID(JSESSIONID, sigaaURL)
