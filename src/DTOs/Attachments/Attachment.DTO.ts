...
export type Attachments = FileDTO | ForumDTO | LinkDTO | QuizDTO | SurveyDTO | VideoDTO | WebContentDTO | HomeworkDTO;
export type AttachmentProps = IFileDTOProps | IForumDTOProps | ILinkDTOProps | IQuizDTOProps | ISurveyDTOProps | IVideoDTOProps | IWebContentDTOProps | IHomeworkDTOProps;
